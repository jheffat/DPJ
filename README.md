...
DPJ has a deeper significance: it was the name of my first encryption tool, created in 2001 with QBASIC(CLI) later in 2005 with VB(GUI) 
[DPJ Basic.exe](https://github.com/jheffat/DPJ/blob/main/scrnsht/DPJ%20Basic%20by%20VB.png). Bringing the name back honors that origin while also marking the maturity of this version.
